...
/* FLASH BANK address */
#define FLASH_BANK1_END_ADDRESS   ((u32)0x807FFFF)
...
FLASH_Status FLASH_UserOptionByteConfig(u16 OB_IWDG, u16 OB_STOP, u16 OB_STDBY)
{
  ...
  {  
    ...
    OB->USER = OB_IWDG | (u16)(OB_STOP | (u16)(OB_STDBY | ((u16)0xF8))); 
...
void FLASH_ITConfig(u32 FLASH_IT, FunctionalState NewState)
{
  ...
  if((FLASH_IT & 0x80000000) != 0x0)
  {
    ...
    else
    {
      ...
      FLASH->CR2 &= ~(u32)(FLASH_IT & 0x7FFFFFFF);
    }
  }
  else
  {
...
FlagStatus FLASH_GetFlagStatus(u32 FLASH_FLAG)
{
  ...
  else
  {
    ...
    {
      if((FLASH->SR2 & FLASH_FLAG) != (u32)RESET)
      {
        bitstatus = SET;
      }
      else
