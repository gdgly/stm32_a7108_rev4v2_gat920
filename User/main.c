...
/* Private define ---------------------------------------------------------------------------------------*/
#define RO_FLashAddr  	((u32)0x080BE800)									//SN存储地址
#define RO_CROSSIDAddr	((u32)0x080BE804)									//CROSSID存储地址
#define RW_StartAddr     ((u32)0x080BF000)
#define RW_FLashAddr_p1  ((u32)0x080BF000)									//接收器参数保存区
#define RW_FLashAddr_p2  ((u32)0x080BF100)									//地磁配置参数保存区
#define RW_FLashAddr_p3  ((u32)0x080BF200)									//输出端口映射保存区
#define RW_FLashAddr_p4	((u32)0x080BF300)									//网络配置参数保存区
