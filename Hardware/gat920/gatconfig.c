...
#define GAT_RO_FLashAddr  	((u32)0x080BE800)								//SN存储地址
#define GAT_RW_StartAddr		((u32)0x080BF800)
#define GAT_RW_FLashAddr_p1	((u32)0x080BF800)								//GAT检测器参数保存区
#define GAT_RW_FLashAddr_p2	((u32)0x080BF900)								//GAT脉冲数据上传配置参数保存区
#define GAT_RW_FLashAddr_p3	((u32)0x080BFA00)								//GAT设备配置参数保存区
