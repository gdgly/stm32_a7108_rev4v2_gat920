...
#define SDIO_SDCARD_D0_GPIOx		GPIOC
#define SDIO_SDCARD_D0_PIN		GPIO_Pin_8
#define SDIO_SDCARD_D1_GPIOx		GPIOC
#define SDIO_SDCARD_D1_PIN		GPIO_Pin_9
#define SDIO_SDCARD_D2_GPIOx		GPIOC
#define SDIO_SDCARD_D2_PIN		GPIO_Pin_10
#define SDIO_SDCARD_D3_GPIOx		GPIOC
#define SDIO_SDCARD_D3_PIN		GPIO_Pin_11

#define SDIO_SDCARD_CLK_GPIOx		GPIOC
#define SDIO_SDCARD_CLK_PIN		GPIO_Pin_12

/*!< Configure PD.02 CMD line */
#define SDIO_SDCARD_CMD_GPIOx		GPIOD
...
/** 
  * @brief  SDIO FIFO Address SDIO地址 + 0x80 ~ SDIO地址 + 0xFC
  */
...
/** 
  ...
  */
#define SDIO_INIT_CLK_DIV		((uint8_t)0x12)

/** 
  * @brief  SDIO Data Transfer Frequency (25MHz max) SDIOCLK = HCLK, SDIO_CK = HCLK/(2 + SDIO_TRANSFER_CLK_DIV)
  */
